            ...
            <div class="flex gap-x-2">
              <?php if ($_SESSION['user'] ?? false) : ?>
                ...
                <form method="POST" action="/session">
                  ...
                  <button class="<?= urlIs("/sessions") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium">Logout</button>
                </form>
