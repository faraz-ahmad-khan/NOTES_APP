...
<?php require base_path('views/partials/banner.php') ?>
  ...
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 relative">
        ...
        <div class="border-double border-2 border-[#3c3c3c] px-2 py-2 rounded-lg pb-14">
          ...
          <div class="mb-4 px-2 py-2 absolute bottom-5 right-12 inline-flex flex-wrap">
            <form method="POST">
              ...
              <button class="rounded-md text-white text-center bg-red-800 px-2 py-2 w-20 hover:bg-red-700 font-medium" href="#">Delete</button>
            </form>
